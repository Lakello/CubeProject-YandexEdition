...
namespace EasyTransition
{
    ...
    {        
        [SerializeField] private Transition transitionTemplate;
        ...
        public void CreateTransition(TransitionSettings settings)
        {
            _currentTransition = Instantiate(transitionTemplate);
        }
